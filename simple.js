...
const dtod = "6289523767913@s.whatsapp.net"

const otod = "6289523767913@s.whatsapp.net"
const ktod = "6289523767913@s.whatsapp.net"

const htod = "6289523767913@s.whatsapp.net"
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		faketeks = 'MoDz RxNc' //Ganti Aja Nama Luh
		const isUrl = (url) => {
...
//━━━━━━━━━━━━━━━[ BUTTON ]━━━━━━━━━━━━━━━━━//
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = simple.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝑴𝑬𝑵𝑼","footerText": `_HELLO KAK_ >.<
✋ 
_*SIMPLENYA*_ :
...
"body": `hy`, 
"mediaType": "2", 
"mediaUrl": "https://youtu.be/_aCjSjXdCAw", 
...
reply('_*Loading*_. . .')	
reply('_*MENU AKAN DI TAMPILKAN*_. . .')
simple.updatePresence(from, Presence.recording)		
...
simple.updatePresence(from, Presence.recording)
   ...
   sendButImage(from, pll, `MODZ BOTZ © 2021`, cewe, [                      
          {
...
//>>>>>>>>>>>>>>>>>>>>[ COMMAND ]<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<//
              ...
              simple.updatePresence(from, Presence.recording)
               list = []
            listmenu = [`shop`,`sewabot`,`groupmenu`,`stickermenu`,`downloadmenu`,`animemenu`,`informationmenu`,`randomtextmenu`,`searchmenu`,`primbonmenu`,`stalkmenu`,`randomimagemenu`,`ownermenu`,`asupan`,`gabut`,`game`,`meme`,`soundmenu`,`makermenu`,]
               listmenuu = [`shop`,`sewabot`,`grupmenu`,`stickermenu`,`downloadmenu`,`animemenu`,`informationmenu`,`randomtextmenu`,`searchmenu`,`primbonmenu`,`stalkmenu`,`randomimagemenu`,`ownermenu`,`asupan`,`gabut`,`game`,`meme`,`soundmenu`,`makermenu`,]
               nombor = 1
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'MDzRxNc',
                    rows: [
                       {
...
costum(buffer, sticker, Verived, `Jangan Lupa Subscribe MODZ BOT`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `©_MODZ BOTZ_ *V : 2.889H*`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
simple.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Subscribe MODZ BOT' })
fs.unlinkSync(ran)
})
break
...
sendButton(from, "GOPAY : 089523767913", faketeks, but, mek)
break
case 'dana':
simple.updatePresence(from, Presence.recording)
but = [
...
sendButton(from, "DANA : 089523767913", faketeks, but, mek)
break
case 'ovo':
simple.updatePresence(from, Presence.recording)
but = [
...
sendButton(from, "OVO : 089523767913", faketeks, but, mek)
break
...
simple.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe MODZ BOT'})
break
case 'hijaber':
...
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
simple.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe MODZ BOT'})
break
case 'ukhti':
...
but = [
        ...
        sendButton(from, teks, '©Created : MDz Bot', but, mek)
break
                ...
                case 'wallgravity':
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=MODZ BOT&text1=${txt1}&text2=${txt2}`).then((gambar) => {
...
Sendbutdocument(from, tescok, "© MODZ BOT*", fs.readFileSync('./poto/menu.pdf'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./poto/image/thumbnaildokumen.jpg'), filename:`MODZ RXNC VIP`, pageCount: 9999999 }, [{buttonId:`!000`,buttonText:{displayText:'Hai‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎\n\nSemuanya aku Adalah MODZ BOT'},type:1}], {quoted:fvid, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`${tampilUcapan} - ${pushname}\nDownload Script`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/_aCjSjXdCAw`}}})
break
